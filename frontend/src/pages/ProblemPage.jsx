...
const ProblemPage = () => {
  ...
  const handleRun = async () => {
    ...
    try {
      ...
      const errorType = error.response?.data?.type || 'Network Error';
      const errorMsg = error.response?.data?.error || error.message || 'Code run failed';
  ...
  const handleAIReview = async () => {
    ...
    try {
      ...
      localStorage.setItem(`aiReviewLastDate-global`, new Date().toISOString().split('T')[0]);
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#0f0f23] via-[#1a1a3a] to-[#2d1b69] flex items-center justify-center">
        <div className="text-center">
          <div className="relative">
            ...
            <div className="absolute inset-0 w-20 h-20 border-4 border-blue-400/20 border-r-blue-400 rounded-full animate-spin mx-auto" style={{ animationDirection: 'reverse', animationDuration: '1.5s' }}></div>
          </div>
          
          <h2 className="text-2xl font-bold bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent mb-3">
            Loading Problem
          </h2>
          <p className="text-gray-300 text-sm mb-4">Preparing your coding environment...</p>
  ...
  return (
    <div className="flex mt-15 flex-col bg-gradient-to-br from-[#0f0f23] via-[#1a1a3a] to-[#2d1b69] text-gray-100 min-h-screen transition-all duration-300">
      ...
      <div 
        ref={containerRef}
        className={`flex-1 flex ${isMobile ? 'flex-col' : 'flex-row'} overflow-hidden transition-all duration-300`}
        style={{ paddingTop: isMobile ? '1rem' : '1rem', padding: isMobile ? '0.5rem' : '1rem' }}
      >
        {/* Enhanced Problem Description Panel */}
        <div 
          className={`overflow-y-auto bg-gray-900/80 backdrop-blur-sm border border-gray-700/50 rounded-xl shadow-2xl ${isMobile ? 'mb-4' : ''}`}
          style={{ 
                ...
                <div className="mt-8 space-y-6">
                  ...
                  <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg border border-gray-700/50 p-4">
                    ...
                    <div className="bg-gray-900/50 p-4 rounded-lg border border-gray-600/30">
                      <pre className="whitespace-pre-wrap break-words text-gray-300 text-sm">{problem.inputFormat}</pre>
                    </div>
                  </div>
                  ...
                  <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg border border-gray-700/50 p-4">
                    ...
                    <div className="bg-gray-900/50 p-4 rounded-lg border border-gray-600/30">
                      <pre className="whitespace-pre-wrap break-words text-gray-300 text-sm">{problem.outputFormat}</pre>
                    </div>
                  </div>
                  ...
                  <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg border border-gray-700/50 p-4">
                    ...
                    <div className="bg-gray-900/50 p-4 rounded-lg border border-gray-600/30">
                      <pre className="whitespace-pre-line break-words text-gray-300 text-sm">{problem.constraints}</pre>
                    </div>
                  </div>
                    ...
                    <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg border border-gray-700/50 p-4">
                      ...
                      <div className="bg-gray-900/50 rounded-lg border border-gray-600/30 overflow-hidden">
                        <div className="p-4 border-b border-gray-600/30">
                          ...
                          <pre className="whitespace-pre-wrap break-words text-gray-300 text-sm">{problem.samples[0].input}</pre>
                        </div>
                        <div className="p-4">
                          <h4 className="text-sm font-medium text-gray-400 mb-2">Output</h4>
                          <pre className="whitespace-pre-wrap break-words text-gray-300 text-sm">{problem.samples[0].output}</pre>
                        </div>
                      </div>
                    </div>
                  )}
        ...
        <div className={`flex-1 flex flex-col ${currentTheme.bg} overflow-hidden min-h-0 rounded-xl border border-gray-700/50 shadow-2xl backdrop-blur-sm`}>
          {/* Enhanced Control Panel */}
          <div className={`flex items-center justify-between p-1.5 ${currentTheme.border} border-b backdrop-blur-sm bg-gray-800/50`}>
              ...
              <>
                ...
                <div
                  className={`p-4 rounded-lg text-sm border backdrop-blur-sm transition-all duration-300 ${
                    ['Wrong Answer', 'Compilation Error', 'Runtime Error', 'Network Error', 'Error'].includes(verdict)
                      ? 'bg-red-500/20 text-red-300 border-red-500/30'
                ...
                {(isRunMode || (!isRunMode && verdict === 'Wrong Answer')) && failedTestCase && (
                  ...
                  <ReactMarkdown
                    ...
                    components={{
                      ...
                      p({ node, children, ...props }) {
                        return (
                          <p className="mb-5 text-slate-200 leading-7 text-base" {...props}>
                            {children}
                          </p>
                        );
                      },
                      ...
                      ul({ node, children, ...props }) {
                        return (
                          <ul className="mb-5 space-y-2 text-slate-200" {...props}>
                            {children}
                          </ul>
                        );
                      },
                      ...
                      ol({ node, children, ...props }) {
                        return (
                          <ol className="mb-5 space-y-2 text-slate-200 list-decimal list-inside" {...props}>
                            {children}
                          </ol>
                        );
                      },
                      ...
                      li({ node, children, ...props }) {
                        return (
                          <li className="flex items-start gap-3 text-slate-200 leading-6" {...props}>
                      ...
                      h1({ node, children, ...props }) {
                        return (
                          <h1 className="text-2xl font-bold text-white mt-8 mb-4 pb-2 border-b border-slate-600" {...props}>
                            {children}
                          </h1>
                        );
                      },
                      ...
                      h2({ node, children, ...props }) {
                        return (
                          <h2 className="text-xl font-semibold text-white mt-7 mb-3 flex items-center gap-2" {...props}>
                      ...
                      h3({ node, children, ...props }) {
                        return (
                          <h3 className="text-lg font-medium text-slate-100 mt-6 mb-2" {...props}>
                            {children}
                          </h3>
                        );
                      },
                      ...
                      blockquote({ node, children, ...props }) {
                        return (
                          <blockquote className="border-l-4 border-blue-500 bg-slate-800/50 pl-6 py-4 my-6 italic text-slate-300 rounded-r-lg" {...props}>
                            {children}
                          </blockquote>
                        );
                      },
                      ...
                      table({ node, children, ...props }) {
                        return (
                          <div className="overflow-x-auto my-6">
                            <table className="w-full border-collapse border border-slate-600 rounded-lg overflow-hidden text-sm" {...props}>
                              {children}
                            </table>
                          </div>
                        );
                      ...
                      th({ node, children, ...props }) {
                        return (
                          <th className="border border-slate-600 bg-slate-700 px-4 py-2 text-left font-semibold text-slate-100" {...props}>
                            {children}
                          </th>
                        );
                      },
                      ...
                      td({ node, children, ...props }) {
                        return (
                          <td className="border border-slate-600 px-4 py-2 text-slate-200" {...props}>
                            {children}
                          </td>
                        );
                      },
